      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="form-inline my-2 my-lg-0">
            ...
            <a href="/login" role="button" class="btn btn-outline-success mr-4" >Login</a>
            <a href="/travelia/registration" role="button" class="btn btn-outline-success mr-4" >Sign up</a>
        ...
        <div class="modal-body">
          <form class="form" action="/login" method="POST">
            <div class="form-group">
              ...
              <input type="text" class="form-control form-control-lg" name="username" id="loginemail" value="{{ $login[0] }}">
          ...
          <form id="reg_form" action="/travelia" method="post">
            <div class="row">
              <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                  <input type="text" name="fullname" require id="full_name" class="form-control input-sm"
                    placeholder="Full Name" value="{{old('fullname')}}">
                  <div class="invalid-feedback">Oops, you missed full name</div>
                </div>
              </div>
              <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                  <input type="text" name="username" require id="user_name" class="form-control input-sm"
                    placeholder="User Name" value="{{old('username')}}">
                  <div class="invalid-feedback">Oops, you missed user name</div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                  <input type="text" name="password" require id="password" class="form-control input-sm" placeholder="Password">
              ...
              <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                  <input type="text" require name="password_confirmation" id="password_confirmation"
